...
function AboutSai() {
    return (
        <div className="bg-[#FFBF42] overflow-hidden relative w-full flex items-center justify-center min-h-screen px-6">
            <div
                style={{
            ...
            <div>
                <div className="max-w-5xl">
                    ...
                    <p className="md:text-lg max-w-[75%] mx-auto font-satoshi font-[500] text-center">
                        ...
                        themselves in other fun events. In thii year's edition,
