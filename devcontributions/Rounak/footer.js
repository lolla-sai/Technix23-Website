    ...
    return (
        <>
            ...
            <div className="flex gap-5 flex-col md:flex-row items-center justify-center relative h-screen ">
                ...
                <div className="m-50 font-satoshi">
                    <div className="mb-10 custom-width">
                        <div className="font-LondrinaSolid text-custom-red text-heading-size">
                            {" "}
                            CONTACT US
                        </div>
                    ...
                    <div className="mb-4">
                        <p className="text-custom-red text-name-size font-bold">
            ...
            <div>
                <CustomButton
                    dest="./#top"
                    styling=" font-LondrinaSolid px-6  md: py-4 text-xl rounded-full top-button bg-custom-pitch"
                >
                ...
                <CustomButton dest="gmail" styling="w-10 shadow-lg">
                    <div className="flex flex-row items-center mt-4 md:mt-0 gmail-button">
                        <BsEnvelope size={40} />
                    </div>
                </CustomButton>
                <CustomButton dest="instagram_link" styling="w-10 shadow-lg">
                    <div className="flex flex-row items-center insta-button mt-4 md:mt-0 ml-2 md:ml-0">
                        <AiOutlineInstagram className="ml-2" size={40} />
                    </div>
                </CustomButton>
                <CustomButton dest="linkedin_link" styling="w-10 shadow-lg">
                    <div className="flex flex-row items-center linkedin-button mt-4 md:mt-0 ml-3 md:ml-0">
